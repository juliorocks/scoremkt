  ...
  return <section className="bg-white py-20">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {benefits.map((benefit, index) => <div key={index} className="bg-white p-8 rounded-2xl border border-gray-100 hover:border-mind-blue/20 hover:shadow-xl transition-all duration-300 group">
