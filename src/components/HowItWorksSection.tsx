  ...
  return <section className="bg-white py-12 sm:py-20 overflow-x-hidden">
      <div className="container mx-auto px-4">
        ...
        <div className="mb-12 sm:mb-16 px-4">
          <img src="https://scoremkt.jhow.com.br/wp-content/uploads/2025/07/Ja-calculou-o-seu-Score-MKT-MIND.webp?w=1200&h=400&fit=crop" alt="Equipe analisando dados de marketing" className="w-full h-48 sm:h-64 object-cover rounded-2xl " />
        </div>
