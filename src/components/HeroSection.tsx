      ...
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
          ...
          animationDelay: '0.3s'
            ...
            <img alt="Dashboard de análise de marketing e métricas de performance" className="w-full h-auto rounded-2xl" src="https://mktscore.com.br/wp-content/uploads/2025/07/Ja-calculou-o-seu-Score-MKT-4.webp" />
          </div>
        </div>
      </div>
    </section>;
